...
| `refineWaitHours` | `24` | How long a session waits for the answers to its **refine** questions — the questions it asks before writing any code when a card is not clear enough to build (see *How it works*) |
