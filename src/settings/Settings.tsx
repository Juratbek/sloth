...
const SECTIONS: { key: Key; label: string; component: ComponentType<SectionProps>; defaults?: (c: SlothConfig) => Partial<SlothConfig> }[] = [
  ...
  { key: 'sessions', label: 'Sessions', component: Sessions, defaults: () => pick('maxActive', 'maxAlive', 'minFreeMemory', 'minIdleCpu', 'minIdleDisk', 'machineSeconds', 'budgetMinutes', 'waitHours', 'reviewRounds', 'maxRetries', 'keepDays') },
