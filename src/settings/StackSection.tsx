  ...
  return (
    <div className="py-4">
      ...
      <p className="mt-0.5 mb-4 text-xs leading-relaxed text-zinc-400">
        ...
        or now, with the button. On Linux Sloth asks for the sudo password once — it goes into a sudoers rule for the exact
        install commands and nothing else — and then installs through an AI session you can watch here.
      </p>
